...
- [ ] **Cnt-7** — Block-based content editing. Notion / Coda / Tana all build documents from typed blocks. New `<BlockEditor>` composing `RichText` + `Markdown` + the block menu. Bounded scope = 8 baseline block types. **3 wk.** Cnt-6 ✅ unblocked.
