...
- `registry.json` — the catalog (props schemas, data sources, supported actions, design tokens, examples). Generated from [`@cir/components`](../packages/components/src/registry.ts) via `pnpm components:sync`.
