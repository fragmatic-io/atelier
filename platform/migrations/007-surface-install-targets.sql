CREATE TABLE surface_installs_next (
 tenant_id TEXT NOT NULL, project_id TEXT NOT NULL, id TEXT NOT NULL,
 framework TEXT NOT NULL CHECK(framework IN('nextjs-app','react-router','dom','vite-react-fastapi')),
...
INSERT INTO surface_installs_next
...
ALTER TABLE surface_installs_next RENAME TO surface_installs;
