 ...
 *
 * Mounted ambiently by `cir-providers.tsx` (outside the manifest tree, like
 ...
 * list required. Aurora's `cir-providers.tsx` seeds the registry with one
 * action per granted CIR capability (`thread.archive`, `task.complete`,
...
import { CommandPalette } from '@cir/components';
