...
template: splash
hero:
  tagline: Five public artifacts at the top. One private artifact below them belongs to the user. The compiler is the only LLM-touching component.
  actions:
    - text: Full architecture chapter
      link: /atelier/concepts/capability/
      icon: right-arrow
      variant: primary
---
